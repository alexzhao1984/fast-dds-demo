...
public:
    ...
    bool init()
    {
        ...
        eprosima::fastrtps::rtps::IPLocator::setIPv4(locator, 192, 168, 1, 11);
        locator.port = 64863;
        ...
        participantQos.wire_protocol().builtin.discovery_config.m_DiscoveryServers.push_back(server);
